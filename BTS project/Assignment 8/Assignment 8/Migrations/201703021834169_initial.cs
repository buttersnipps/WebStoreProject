namespace Assignment_8.Migrations
{
    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        currentOrder_ProductId = c.Int(),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Products", t => t.currentOrder_ProductId)
                .Index(t => t.currentOrder_ProductId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Orders", "currentOrder_ProductId", "dbo.Products");
            ...
            DropIndex("dbo.Orders", new[] { "currentOrder_ProductId" });
